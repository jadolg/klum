...
func (c *version) UserSync() UserSyncController {
	return NewUserSyncController(schema.GroupVersionKind{Group: "klum.cattle.io", Version: "v1alpha1", Kind: "UserSync"}, "usersyncs", false, c.controllerFactory)
}
